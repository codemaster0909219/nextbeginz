  ...
  return (
    ...
    >
      ...
      {children && (
        <div
          className={cn(
            "grid relative place-content-center overflow-hidden rounded-[15px] border border-neutral-950 bg-black/50",
            className
          )}
        >
          {children}
      ...
      <div className="relative px-4 pb-2 pt-4">
        <h3 className="text-3xl font-semibold text-neutral-300">{title}</h3>
