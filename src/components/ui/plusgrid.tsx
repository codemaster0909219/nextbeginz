...
export function PlusGridRow({
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-x-0 top-0 border-t border-white/40"></div>
        <div className="absolute inset-x-0 top-2 border-t border-white/40"></div>
        <div className="absolute inset-x-0 bottom-2 hidden border-b group-last/row:block border-white/40"></div>
      </div>
      {children}
    </div>
  );
...
export function PlusGridIcon({
  ...
  return (
    <svg
      ...
      className={clsx(
        className,
        "absolute size-[15px] fill-white/40",
        yClass,
        xClass,
      )}
    >
