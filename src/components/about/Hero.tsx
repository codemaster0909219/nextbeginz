        ...
        <div className="flex justify-center mt-8 ">
          <div className="inline-flex relative">
            <WavyText
              ...
              text="Your Strategic Partner in Digital Growth"
            />
          </div>
        </div>
        <div className="flex justify-center">
          <p className='text-xl text-center mt-8 max-w-2xl'>We combine experience, innovation, and reliability to deliver real results.</p>
        </div>
      </div>
    </div>
  )
